      ...
      <div className="relative mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="mb-6 text-4xl font-bold leading-tight tracking-tight sm:text-5xl md:text-6xl">
            Profesjonalne korepetycje z języka angielskiego
          </h1>
          <p className="mb-4 text-lg font-medium text-zinc-100 md:text-2xl">
            Zacznij mówić pewnie po angielsku z Anglo Mania
          </p>
          <p className="mx-auto mb-8 max-w-3xl text-base leading-7 text-zinc-300 md:text-lg">
            Indywidualne lekcje dostosowane do Twoich potrzeb. Efektywne metody nauczania, przyjazna atmosfera i gwarancja postępów.
          </p>
          ...
          <p className="text-sm font-medium text-sky-200">✨ Pierwsza konsultacja zupełnie za darmo</p>
        </div>
      </div>
    </section>
  );
